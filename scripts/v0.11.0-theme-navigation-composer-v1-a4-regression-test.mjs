...
pass(store.includes('themeNavigation=resolveThemeNavigation(themePackage,experience)')&&/const value=\{[^}]*themeNavigation/.test(store),'resolved Navigation Composer state is exposed through StoreContext without freezing neighboring property order');
