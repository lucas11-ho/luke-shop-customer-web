...
pass(store.includes('themeNavigation=resolveThemeNavigation(themePackage,experience)')&&store.includes('themePackage,themeComponents,themeNavigation,themeButtons'),'resolved Navigation Composer state is exposed through StoreContext without freezing additive properties');
